...
- The standard environment variables set by devtools:
  [`r_env_vars()`](https://devtools.r-lib.org/reference/r_env_vars.md).
...
[`release()`](https://devtools.r-lib.org/reference/release.md) if you
want to send the checked package to CRAN.
