...
test_that("bioc repo paths are parsed correctly", {
  expect_equal(parse_bioc_repo("devtools#abc123"), list(repo="devtools", revision="abc123"))
  ...
  expect_equal(parse_bioc_repo("user:pass@devtools#abc123"), list(username = "user", password = "pass", repo="devtools", revision = "abc123"))
  expect_error(parse_bioc_repo("user:pass@3.1/devtools#abc123"), "release and revision should not both be specified")
