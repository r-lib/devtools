...
- [`install()`](https://devtools.r-lib.org/reference/install.md) uses a
  new feature of
...
- Package installation functions are now deprecated:
  [`install_bioc()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_bitbucket()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_cran()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_deps()`](https://devtools.r-lib.org/reference/install_deps.md),
  [`install_dev()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_dev_deps()`](https://devtools.r-lib.org/reference/install_deps.md),
  [`install_git()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_github()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_gitlab()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_local()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_svn()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_url()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`install_version()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`update_packages()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`dev_package_deps()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  [`github_pull()`](https://devtools.r-lib.org/reference/install-deprecated.md),
  and
...
- [`build_rmd()`](https://devtools.r-lib.org/reference/build_rmd.md) is
  soft-deprecated and is discouraged for external use. It exists to be
  an internal helper for
  [`build_readme()`](https://devtools.r-lib.org/reference/build_readme.md).
- [`build_vignettes()`](https://devtools.r-lib.org/reference/build_vignettes.md)
  and
  [`clean_vignettes()`](https://devtools.r-lib.org/reference/clean_vignettes.md)
...
- [`test_file()`](https://devtools.r-lib.org/reference/devtools-defunct.md)
  and
  [`test_coverage_file()`](https://devtools.r-lib.org/reference/devtools-defunct.md)
  are now defunct. These were deprecated in devtools 2.4.0 (2021-04-07)
  in favour of
  [`test_active_file()`](https://devtools.r-lib.org/reference/test.md)
  and
  [`test_coverage_active_file()`](https://devtools.r-lib.org/reference/test.md).
  Removing
  [`test_file()`](https://devtools.r-lib.org/reference/devtools-defunct.md)
  eliminates the conflict with
  [`testthat::test_file()`](https://testthat.r-lib.org/reference/test_file.html).
- [`release()`](https://devtools.r-lib.org/reference/release.md) is
  deprecated in favour of
  [`usethis::use_release_issue()`](https://usethis.r-lib.org/reference/use_release_issue.html).
- [`create()`](https://devtools.r-lib.org/reference/create.md) is
  deprecated in favour
  of[`usethis::create_package()`](https://usethis.r-lib.org/reference/create_package.html).
- [`bash()`](https://devtools.r-lib.org/reference/bash.md),
  [`missing_s3()`](https://devtools.r-lib.org/reference/missing_s3.md),
  [`reload()`](https://devtools.r-lib.org/reference/reload.md),
  [`show_news()`](https://devtools.r-lib.org/reference/show_news.md),
  and [`wd()`](https://devtools.r-lib.org/reference/wd.md) are now
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) now
  ...
  installs.
- [`build_manual()`](https://devtools.r-lib.org/reference/build_manual.md)
  reports more details on failure
  ([\#2586](https://github.com/r-lib/devtools/issues/2586)).
- [`build_site()`](https://devtools.r-lib.org/reference/build_site.md)
  now just calls
...
- [`check_doc_fields()`](https://devtools.r-lib.org/reference/check_doc_fields.md)
...
- [`check_mac_devel()`](https://devtools.r-lib.org/reference/check_mac_release.md)
...
- [`check_win()`](https://devtools.r-lib.org/reference/check_win.md) and
  friends gain a `webform` argument that uses a webform instead of
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) now
  errors if called recursively, i.e. if you accidentally include a
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) call
  in one of your R source files
  ([\#2617](https://github.com/r-lib/devtools/issues/2617)).
- [`show_news()`](https://devtools.r-lib.org/reference/show_news.md) now
  looks for NEWS files in the same locations as
...
- [`test_coverage()`](https://devtools.r-lib.org/reference/test.md) and
  [`test_coverage_active_file()`](https://devtools.r-lib.org/reference/test.md)
...
- [`test_coverage()`](https://devtools.r-lib.org/reference/test.md) now
  works if the package has not been installed.

- [`test_coverage_active_file()`](https://devtools.r-lib.org/reference/test.md)
  now reports if any tests failed and does a better job of executing
  snapshot comparisons.

- [`dev_mode()`](https://devtools.r-lib.org/reference/dev_mode.md) and
  [`check_rhub()`](https://devtools.r-lib.org/reference/check_rhub.md)
  are deprecated.
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) and
  [`test_active_file()`](https://devtools.r-lib.org/reference/test.md)
  once again work with testthat itself.

- [`dev_mode()`](https://devtools.r-lib.org/reference/dev_mode.md) is
  deprecated ([@billdenney](https://github.com/billdenney),
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) no longer
  calls [`load_all()`](https://devtools.r-lib.org/reference/load_all.md)
  twice.
  [`test_active_file()`](https://devtools.r-lib.org/reference/test.md)
  now calls
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) via
  testthat.
...
- New
  [`check_mac_release()`](https://devtools.r-lib.org/reference/check_mac_release.md)
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) and
  [`submit_cran()`](https://devtools.r-lib.org/reference/submit_cran.md)
...
- [`check_man()`](https://devtools.r-lib.org/reference/check_man.md) now
  works with R versions 4.1+
...
- New Rstudio addin for
  [`run_examples()`](https://devtools.r-lib.org/reference/run_examples.md)
...
- [`create()`](https://devtools.r-lib.org/reference/create.md) no longer
  opens projects by default to avoid duplicate projects opened by the
  RStudio IDE project template
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now only
  re-documents if you have a matching version of roxygen2
...
- Now uses testthat 3.0.0 to power
  [`test()`](https://devtools.r-lib.org/reference/test.md),
  [`test_active_file()`](https://devtools.r-lib.org/reference/test.md),
  [`test_coverage()`](https://devtools.r-lib.org/reference/test.md), and
  [`test_coverage_active_file()`](https://devtools.r-lib.org/reference/test.md).
...
- [`build()`](https://devtools.r-lib.org/reference/build.md) now errors
  with a more informative error message when passed an invalid `pkg`.
  ([\#2177](https://github.com/r-lib/devtools/issues/2177))

- New [`build_rmd()`](https://devtools.r-lib.org/reference/build_rmd.md)
...
- [`spell_check()`](https://devtools.r-lib.org/reference/spell_check.md)
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) gains a
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now sets
  `NOT_CRAN=true` by default, as was originally intended
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) now takes
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) now
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) now sets the
  collation order to `C` before running, which matches the behavior of
  tests when run with `R CMD check`
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) no
  longer calls the deprecated `dr_devtools()`
  ([\#2105](https://github.com/r-lib/devtools/issues/2105))

- [`test()`](https://devtools.r-lib.org/reference/test.md) now
...
- [`create()`](https://devtools.r-lib.org/reference/create.md) added
  back, the RStudio IDE uses
  [`create()`](https://devtools.r-lib.org/reference/create.md) in the
  create packages dialog, so removing it in version 2.1.0 broke old
  versions of the IDE.
...
- [`document()`](https://devtools.r-lib.org/reference/document.md) gains
  a `quiet` parameter, to silence output and
  [`check()`](https://devtools.r-lib.org/reference/check.md) now passes
  its quiet argument to it
...
- [`check_man()`](https://devtools.r-lib.org/reference/check_man.md) now
  succeeds when [`tools::undoc()`](https://rdrr.io/r/tools/undoc.html)
  returns empty results
  ([\#1944](https://github.com/r-lib/devtools/issues/1944)).
...
- [`create()`](https://devtools.r-lib.org/reference/create.md) added,
  the RStudio IDE uses
  [`create()`](https://devtools.r-lib.org/reference/create.md), so
...
- [`create()`](https://devtools.r-lib.org/reference/create.md),
...
- `yesno()` as used in
  [`release()`](https://devtools.r-lib.org/reference/release.md) now has
  clearer synonyms for “yes”
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) now
  accepts ‘package’ objects, regaining previous behavior in devtools
  prior to 2.0.0
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now
...
- Add a RStudio addin for
  [`test_coverage()`](https://devtools.r-lib.org/reference/test.md).
...
- remotes: Installing packages
  (i.e. [`install_github()`](https://devtools.r-lib.org/reference/install-deprecated.md)).
- pkgbuild: Building binary packages (including checking if build tools
  are available)
  (i.e. [`build()`](https://devtools.r-lib.org/reference/build.md)).
- pkgload: Simulating package loading
  (i.e. [`load_all()`](https://devtools.r-lib.org/reference/load_all.md)).
- rcmdcheck: Running R CMD check and reporting the results
  (i.e. [`check()`](https://devtools.r-lib.org/reference/check.md)).
...
- [`devtools::install()`](https://devtools.r-lib.org/reference/install.md)
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) argument
  `check_version` has been renamed to `remote` to better describe what
  tests are disabled
...
- **devtools** now depends on **roxygen2** 6.1.0: this considerably
  simplifies
  [`devtools::document()`](https://devtools.r-lib.org/reference/document.md)
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now uses
  **rcmdcheck** to run and parse R CMD check output
...
- Code related to simulating package loading has been pulled out into a
  ...
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) and
  [`unload()`](https://pkgload.r-lib.org/reference/unload.html) have
...
- [`find_rtools()`](https://pkgbuild.r-lib.org/reference/has_rtools.html),
  ...
  `compiler_flags()`,
  [`build()`](https://devtools.r-lib.org/reference/build.md) and
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) output now
  works more nicely with recent changes to **rcmdcheck**
  ([\#1874](https://github.com/r-lib/devtools/issues/1874)).

- [`reload()`](https://devtools.r-lib.org/reference/reload.md) now
...
- [`save_all()`](https://devtools.r-lib.org/reference/save_all.md)
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now allows
  users to run without `--timings`
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) gains
  an additional question ensuring you updated codemeta.json if one
  exists ([\#1774](https://github.com/r-lib/devtools/issues/1774),
  [\#1754](https://github.com/r-lib/devtools/issues/1754))

- [`test()`](https://devtools.r-lib.org/reference/test.md) now sets
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) and
  [`check_built()`](https://devtools.r-lib.org/reference/check.md) now
  have an `error_on` argument to specify if they should throw an error
  on check failures. When run non-interactively this is set to
  “warnings” unless specified.

- [`check()`](https://devtools.r-lib.org/reference/check.md) now sets
  `_R_CHECK_CRAN_INCOMING_REMOTE_` instead of
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) has
...
- [`document()`](https://devtools.r-lib.org/reference/document.md),
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md),
  [`check()`](https://devtools.r-lib.org/reference/check.md),
  [`build()`](https://devtools.r-lib.org/reference/build.md) and
  [`test()`](https://devtools.r-lib.org/reference/test.md) now
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) once
  again looks for additional release questions in the correct
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) defaults to
  running
  [`document()`](https://devtools.r-lib.org/reference/document.md) only
  if you have used roxygen previously
...
- [`source_gist()`](https://devtools.r-lib.org/reference/source_gist.md)
...
- In order to not run test helpers in
  [`document()`](https://devtools.r-lib.org/reference/document.md), the
  `helpers` argument of
   [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) is
  set to `FALSE` ([@nbenn](https://github.com/nbenn),
...
- If the **foghorn** package is installed,
  [`release()`](https://devtools.r-lib.org/reference/release.md)
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) no
  longer automatically creates a description for you.

- `use_test()` template no longer includes useless comments
  ([\#1349](https://github.com/r-lib/devtools/issues/1349))

- Fix [`test()`](https://devtools.r-lib.org/reference/test.md)
...
- Improved handling of local `file://` repositories in
  [`install()`](https://devtools.r-lib.org/reference/install.md)
  ([\#1284](https://github.com/r-lib/devtools/issues/1284),
  [@krlmlr](https://github.com/krlmlr)).

- `setup()` and
  [`create()`](https://devtools.r-lib.org/reference/create.md) gain new
  `quiet` argument
  ([\#1284](https://github.com/r-lib/devtools/issues/1284),
  [@krlmlr](https://github.com/krlmlr)).
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) doesn’t load
  helpers twice anymore ([@krlmlr](https://github.com/krlmlr),
...
- [`check_man()`](https://devtools.r-lib.org/reference/check_man.md) now
  prints a message if no problems are found
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) runs
  package hooks before sourcing test helper files allowing test helper
  to make use of objects created when a package is loaded or attached.
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now always
  succeeds (instead of throwing an error when `R CMD check` finds an
  `ERROR`), returning an object that summarises the check failures.

- [`check()`](https://devtools.r-lib.org/reference/check.md) gains
  ...
  `FALSE`, but
  [`release()`](https://devtools.r-lib.org/reference/release.md) runs
  check with it set to `TRUE`
  ([\#1071](https://github.com/r-lib/devtools/issues/1071);
  [\#1087](https://github.com/r-lib/devtools/issues/1087),
  [@krlmlr](https://github.com/krlmlr)).

- The `cleanup` argument to
  [`check()`](https://devtools.r-lib.org/reference/check.md) is
  deprecated: it now always returns the path to the check directory.

- [`check_built()`](https://devtools.r-lib.org/reference/check.md)
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) gains
  an `args` argument to control build options, e.g. to allow passing
  `args = "--compact-vignettes=both"` for packages with heavy PDF
  vignettes ([@krlmlr](https://github.com/krlmlr),
...
the other [`revdep()`](https://devtools.r-lib.org/reference/revdep.md)
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) now
  sources all test helpers if you use testthat. This makes it much
  easier to interactively run tests
  ([\#1125](https://github.com/r-lib/devtools/issues/1125)).
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) also
  correctly handles `unix` and `windows` subdirectories within `R`
  ([@gaborcsardi](https://github.com/gaborcsardi),
...
- Devtools uses a new strategy for detecting RTools on windows: it now
  ...
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) or
  [`build()`](https://devtools.r-lib.org/reference/build.md) a package
  with compiled code. This should make it easier to work with devtools
  if you’re developing pure R packages
  ([\#947](https://github.com/r-lib/devtools/issues/947)).

- [`package_file()`](https://devtools.r-lib.org/reference/package_file.md)
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) gains a
  `metadata` argument which lets you add extra fields to the
...
- [`check_man()`](https://devtools.r-lib.org/reference/check_man.md)
...
- [`create()`](https://devtools.r-lib.org/reference/create.md) produces
  a dummy namespace will fake comment so roxygen2 will overwrite
  silently ([\#1016](https://github.com/r-lib/devtools/issues/1016)).

- [`create()`](https://devtools.r-lib.org/reference/create.md) and
...
- [`document()`](https://devtools.r-lib.org/reference/document.md) now
  only runs `update_collate()` once.
...
- [`release_checks()`](https://devtools.r-lib.org/reference/release_checks.md)
...
- Remove explicit [`library(testthat)`](https://testthat.r-lib.org) call
  in [`test()`](https://devtools.r-lib.org/reference/test.md)
  ([\#798](https://github.com/r-lib/devtools/issues/798),
  [@krlmlr](https://github.com/krlmlr)).

- [`as.package()`](https://devtools.r-lib.org/reference/as.package.md)
  and [`load_all()`](https://devtools.r-lib.org/reference/load_all.md)
  gain new argument `create`. Like other functions with a `pkg`
  argument,
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) looks
  for a `DESCRIPTION` file in parent directories - if `create = TRUE` it
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now uses a
  better strategy when `cran = TRUE`. Instead of attempting to simulate
  `--as-cran` behaviour by turning on certain env vars, it now uses
  `--as-cran` and turns off problematic checks with env vars
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) can now
  install dependencies from remote repositories by specifying them as
  `Remotes` in the `DESCRIPTION` file
  ([\#902](https://github.com/r-lib/devtools/issues/902),
  [@jimhester](https://github.com/jimhester)). See
  [`vignette("dependencies")`](https://devtools.r-lib.org/articles/dependencies.md)
  for more details.
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) no
  longer fails if a `useDynLib()` entry in the NAMESPACE is incorrect.
  This should make it easy to recover from an incorrect `@useDynLib`,
  because re-documenting() should now succeed.

- [`release()`](https://devtools.r-lib.org/reference/release.md) works
...
- New [`uninstall()`](https://devtools.r-lib.org/reference/uninstall.md)
...
- [`uses_testthat()`](https://devtools.r-lib.org/reference/uses_testthat.md)
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) warns
  (instead of failing) if importing symbols, methods, or classes from
  `NAMESPACE` fails ([@krlmlr](https://github.com/krlmlr),
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) and
  [`install_deps()`](https://devtools.r-lib.org/reference/install_deps.md)
...
- Previously, devtools ran all external R processes with `R --vanilla`.
  ...
  dependency check in
  [`devtools::release`](https://devtools.r-lib.org/reference/release.md)
...
- [`lint()`](https://devtools.r-lib.org/reference/lint.md) gains a
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) gains an
...
[`revdep_maintainers()`](https://devtools.r-lib.org/reference/revdep.md)
...
- [`lint()`](https://devtools.r-lib.org/reference/lint.md) runs
...
- Deprecated `doc_clean` argument to
  [`check()`](https://devtools.r-lib.org/reference/check.md) has been
  removed.

- Initial package version in
  [`create()`](https://devtools.r-lib.org/reference/create.md) is now
  `0.0.0.9000` ([\#632](https://github.com/r-lib/devtools/issues/632)).
  [`create()`](https://devtools.r-lib.org/reference/create.md) and
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) no
  ...
  [@krlmlr](https://github.com/krlmlr)).
  [`build()`](https://devtools.r-lib.org/reference/build.md) gains an
  additional argument `manual`, defaulting to `FALSE`, and
  [`check()`](https://devtools.r-lib.org/reference/check.md) gains `...`
  unmodified to
  [`build()`](https://devtools.r-lib.org/reference/build.md).
...
- New `setup()` works like
  [`create()`](https://devtools.r-lib.org/reference/create.md) but
...
- [`create()`](https://devtools.r-lib.org/reference/create.md) no longer
  generates `man/` directory - roxygen2 now does this automatically. It
  also no longer generates an package-level doc template. If you want
  this, use `use_package_doc()`. It also makes a dummy namespace so that
  you can build & reload without running
  [`document()`](https://devtools.r-lib.org/reference/document.md)
  first.
...
- You can add arbitrary extra questions to
  [`release()`](https://devtools.r-lib.org/reference/release.md) by
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) uses
  new CRAN submission process, as implemented by
  [`submit_cran()`](https://devtools.r-lib.org/reference/submit_cran.md)
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) no
  longer fails on partial loading of a package containing S4 or RC
...
- [`help()`](https://rdrr.io/r/utils/help.html), `?`, and
  ...
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md), even
  if the devtools package isn’t attached.

- `httr` 0.3 required ([@krlmlr](https://github.com/krlmlr),
  [\#466](https://github.com/r-lib/devtools/issues/466)).

- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) no
  longer gives an error when objects listed as exports are missing.

- Shim added for
  [`library.dynam.unload()`](https://rdrr.io/r/base/library.dynam.html).

- [`loaded_packages()`](https://devtools.r-lib.org/reference/loaded_packages.md)
...
- The `fresh` argument to
  [`test()`](https://devtools.r-lib.org/reference/test.md) has been
...
- `add_test_infrastructure()` will create test infrastructure for a new
  ...
  [`test()`](https://devtools.r-lib.org/reference/test.md) if no test
...
- `add_rstudio_project()` adds an RStudio project file to your package.
  [`create()`](https://devtools.r-lib.org/reference/create.md) gains an
  `rstudio` argument which will automatically create an RStudio project
  in the package directory. It defaults to `TRUE`: if you don’t use
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) gains
  `thread` argument which allows you to install multiple packages in
  parallel ([@mllg](https://github.com/mllg),
...
- `check_devtools()` no longer called by
  [`check()`](https://devtools.r-lib.org/reference/check.md) because the
...
- [`build()`](https://devtools.r-lib.org/reference/build.md) no longer
  checks for `pdflatex` when building vignettes, as many modern
...
- [`release()`](https://devtools.r-lib.org/reference/release.md) does a
  better job of opening your email client if you’re inside of RStudio
  ([\#433](https://github.com/r-lib/devtools/issues/433)).
...
- Fixed bug in [`wd()`](https://devtools.r-lib.org/reference/wd.md) when
  `path` was omitted.
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) gains a
  `build_vignettes` which defaults to TRUE, and ensures that vignettes
  are built even when doing a local install. It does this by forcing
  `local = FALSE` if the package has vignettes, so `R CMD build` can
...
- [`install()`](https://devtools.r-lib.org/reference/install.md) also
  installs the dependencies that do not have the required versions;
...
- [`source_url()`](https://devtools.r-lib.org/reference/source_url.md)
  (and
  [`source_gist()`](https://devtools.r-lib.org/reference/source_gist.md))
...
- [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) now
  defaults to `reset = TRUE` so that changes to the NAMESPACE etc. are
  incorporated. This makes it slightly slower (but hopefully not
  noticeably so), and generally more accurate, and a better simulation
  of the install + restart + reload cycle.

- [`test()`](https://devtools.r-lib.org/reference/test.md) now looks in
  both `inst/test` and `tests/testthat` for unit tests. It is
...
- [`build()`](https://devtools.r-lib.org/reference/build.md) gains
  `args` parameter allowing you to add additional arbitrary arguments,
  and [`check()`](https://devtools.r-lib.org/reference/check.md) gains
  similar `build_args` parameter.
...
- Fix bug so that
  [`document()`](https://devtools.r-lib.org/reference/document.md) will
  automatically create `man/` directory
...
- If there’s no `DESCRIPTION` file present,
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md) will
  automatically create one using `create_description()`. You can set
  options in your `.Rprofile` to control what it contains: see
  [`package?devtools`](https://devtools.r-lib.org/reference/devtools-package.md)
  for more details.

### Minor improvements

- [`check()`](https://devtools.r-lib.org/reference/check.md) now also
  sets environment variable `_R_CHECK_CODE_DATA_INTO_GLOBALENV_` to TRUE
  (to match current `--as-cran` behaviour) (Fixes
...
- [`create()`](https://devtools.r-lib.org/reference/create.md) gains a
  `check` argument which defaults to FALSE.

- `with_env` will be deprecated in 1.2 and removed in 1.3

- When [`load_all()`](https://devtools.r-lib.org/reference/load_all.md)
...
- [`test()`](https://devtools.r-lib.org/reference/test.md) and
  [`document()`](https://devtools.r-lib.org/reference/document.md) now
  set environment variables, including NOT_CRAN.
...
- [`check()`](https://devtools.r-lib.org/reference/check.md) now makes
  the CRAN version check optional, and off by default. The
  [`release()`](https://devtools.r-lib.org/reference/release.md)
  function still checks the version number against CRAN.

- In [`check()`](https://devtools.r-lib.org/reference/check.md), it is
  optional to require suggested packages, using the `force_suggests`
  option.

- When [`check()`](https://devtools.r-lib.org/reference/check.md) is
...
- If `pdflatex` isn’t available, don’t try to build vignettes with
  [`install()`](https://devtools.r-lib.org/reference/install.md) or
  [`check()`](https://devtools.r-lib.org/reference/check.md). (Fixes
...
- [`build()`](https://devtools.r-lib.org/reference/build.md) now has a
  `vignettes` option to turn off rebuilding vignettes.
...
- [`revdep()`](https://devtools.r-lib.org/reference/revdep.md) now lists
  “Suggests” packages, in addition to “Depends” and “Imports”.

- `revdep_check()` now correctly passes the `recursive` argument to
  [`revdep()`](https://devtools.r-lib.org/reference/revdep.md).
...
- When a package is loaded with
  [`load_all()`](https://devtools.r-lib.org/reference/load_all.md), it
  now passes the name of the package to the `.onLoad()` function.
...
- [`build()`](https://devtools.r-lib.org/reference/build.md),
  [`check()`](https://devtools.r-lib.org/reference/check.md),
  [`install()`](https://devtools.r-lib.org/reference/install.md) etc now
  run R in `--vanilla` mode which prevents it from reading any of your
  site or personal configuration files. This should prevent
...
- new [`bash()`](https://devtools.r-lib.org/reference/bash.md) function
  that starts bash shell in package directory. Useful if you want to use
  git etc.
